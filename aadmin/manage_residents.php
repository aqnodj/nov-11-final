...
<?php include 'admin_sidenav.php'; ?> 
    ...
    <div id="content" class="container-fluid">
        ...
        <a href="manage_residents.php?export=csv" class="btn btn-success">Export to CSV</a> 
        &nbsp; &nbsp; &nbsp;
        <a href="manage_residents.php?export=pdf" class="btn btn-primary">Export to PDF</a> 
    </div>
